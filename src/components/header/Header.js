			...
			<div className="max-w-screen-2xl mx-auto px-3 sm:px-10">
				<div className="flex justify-between text-gray-700 text-xs py-2 font-sans font-medium border-b  ">
					...
					<div className="flex items-center lg:text-right ">
						<Link
							to="about-us"
							className=" !text-black !no-underline font-medium cursor-pointer hover:!text-emerald-600"
						>
							About Us
						</Link>
						...
						<Link
							to="contact-us"
							className="!no-underline !text-black font-medium cursor-pointer hover:!text-emerald-600"
						>
							Contact Us
						</Link>
						<span className="mx-2">|</span>
